...
**Langkah 1**: Bandingkan A dan B

- `A[^0] = 1` vs `B[^0] = 2`
- `1 ≤ 2` → Ambil dari A
- `result = [^1]`, `i = 1`, `j = 0`

**Langkah 2**: Bandingkan A dan B[^1]

- `A[^1] = 3` vs `B[^0] = 2`
- `3 > 2` → Ambil dari B
- `result = [1, 2]`, `i = 1`, `j = 1`

**Langkah 3**: Bandingkan A dan B[^1]

- `A[^1] = 3` vs `B[^1] = 4`
- `3 ≤ 4` → Ambil dari A
- `result = [1, 2, 3]`, `i = 2`, `j = 1`

**Langkah 4**: Bandingkan A dan B[^2][^1]

- `A[^2] = 5` vs `B[^1] = 4`
- `5 > 4` → Ambil dari B
- `result = [1, 2, 3, 4]`, `i = 2`, `j = 2`

**Langkah 5**: Bandingkan A dan B[^2]

- `A[^2] = 5` vs `B[^2] = 6`
- `5 ≤ 6` → Ambil dari A
- `result = [1, 2, 3, 4, 5]`, `i = 3`, `j = 2`

**Langkah 6**: Bandingkan A dan B[^3][^2]

- `A[^3] = 7` vs `B[^2] = 6`
- `7 > 6` → Ambil dari B
- `result = [1, 2, 3, 4, 5, 6]`, `i = 3`, `j = 3`

**Langkah 7**: Bandingkan A dan B[^3]
...
[^1]: https://arxiv.org/html/2312.13377v4

[^2]: https://arxiv.org/html/2401.11453v1

[^3]: https://arxiv.org/html/2502.16485v1

[^4]: https://arxiv.org/pdf/2101.12727.pdf

[^5]: https://arxiv.org/pdf/2503.08749.pdf

[^6]: https://www.mdpi.com/1099-4300/24/5/577/pdf?version=1650448472

[^7]: https://aclanthology.org/2023.emnlp-main.799.pdf

[^8]: https://www.mdpi.com/1660-4601/12/6/6352/pdf

[^9]: https://www.youtube.com/watch?v=iMc994VZMhQ

[^10]: https://github.com/MakeContributions/DSA

[^11]: https://github.com/SDA

[^12]: https://www.youtube.com/watch?v=7r05126pOk8

[^13]: https://www.youtube.com/watch?v=C9PiGWuW4VA

[^14]: https://github.com/sdan

[^15]: https://cyrillschumacher.com/github-starred/

[^16]: https://github.com/topics/sda?o=desc\&s=

[^17]: https://docs.opensafely.org/repositories/

[^18]: https://gist.github.com/virattt

[^19]: https://www.mdpi.com/1424-8220/25/7/2112

[^20]: http://arxiv.org/pdf/1307.6769.pdf

[^21]: http://arxiv.org/pdf/2310.01961.pdf

[^22]: https://gist.github.com/dfm/aadf83d23c8937a2fa27

[^23]: https://github.com/orgs/github/repositories

[^24]: https://www.github-zh.com/topics/sda

[^25]: https://github.com/infinitedim

[^26]: https://gist.github.com/vinkla/dca76249ba6b73c5dd66a4e986df4c8d

[^27]: https://github.com/DimasGitbye

[^28]: https://gist.github.com/sandeshrajbhandari

[^29]: https://github.com/dsapoetra

[^30]: https://gist.github.com/sunnygops?direction=asc\&sort=updated
